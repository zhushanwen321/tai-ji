/**
 * useAppUpdate* composables 测试共享 IPC 桥 mock 底座（r2-01 顺路消化，test-infra-source-simplify-2026-09 §3 R5）。
 *
...
import type { LatestReleaseInfo, LaunchResult, UpdateCheckResult, UpdateInstallResult } from '@taiji/shared'
