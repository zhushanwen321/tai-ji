...
export default {
  ...
  menu: {
    ...
    preset: 'Mode',
    presetDesc: 'Manage modes, tool/extension access policies and prompts',
    worktree: 'Workspace',
  ...
  command: {
    ...
    'open-preset-select': 'Open mode selector',
  },
  // ── Preset page (PiPresetsPage) ──
  preset: {
    pageDesc: 'Manage modes, configure tool, extension and prompt access policies',
    groupTitle: 'Modes',
    new: 'New Mode',
    empty: 'No modes',
    builtin: 'Built-in',
    ...
    descPlaceholder: 'Mode description (optional)',
    deleteConfirmTitle: 'Delete {name}?',
    deleteConfirmDesc: 'This cannot be undone. The custom mode will be permanently deleted.',
    promptReplaceTitle: 'Replace system prompt',
    promptReplaceWarning: 'When enabled, the text below replaces the pi built-in behavior spec (tool discipline and safety boundaries). Use with caution.',
    promptReplaceLabel: 'Replacement prompt',
    promptReplacePlaceholder: 'Enter the text that replaces the pi system prompt…',
    promptAppendTitle: 'Append prompt',
    promptAppendHint: 'Appended after the pi base prompt and applied alongside the built-in spec; use it to add mode-specific discipline.',
    promptAppendLabel: 'Appended prompt',
    promptAppendPlaceholder: 'Enter the text appended after the pi base prompt…',
    promptCombinedCount: 'Total {count} / {max}',
    promptSave: 'Save',
    promptDiscard: 'Discard',
    promptRestoreDefault: 'Restore Default',
    promptSaved: 'Mode prompt saved',
    promptReplaceConfirmTitle: 'Enable replacement prompt?',
    promptReplaceConfirmDesc: 'After saving, sessions created with this mode lose the pi built-in behavior spec and receive only your replacement prompt. Cancel to switch to append-only.',
    promptReplaceConfirmBtn: 'Save Anyway',
    promptReplaceConfirmCancel: 'Append Only',
    deleteConfirmBtn: 'Confirm delete',
    cancel: 'Cancel',
