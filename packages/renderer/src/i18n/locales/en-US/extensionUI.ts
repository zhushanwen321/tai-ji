export default {
  ...
  scheduleCreatePickerTimeLabel: 'Time',
  scheduleCreatePickerPrevMonth: 'Previous month',
  scheduleCreatePickerNextMonth: 'Next month',
  scheduleCreatePickerHour: 'Hour',
  scheduleCreatePickerMinute: 'Minute',
  scheduleCreatePickerStepUp: 'Increase',
  scheduleCreatePickerStepDown: 'Decrease',
