// src/execution/assembly/host-mode.ts
//
// 主进程运行模式分类工具。
//
...
// docs/extensions/tui-rendering-pitfalls.md 第四部分第 8 节。
 ...
 *  - "gui"：taiji GUI，通过 rpc sidecar 通道与前端 Vue 组件交互
 ...
 *  - "rpc" → gui（taiji GUI，sidecar 通道可用）
