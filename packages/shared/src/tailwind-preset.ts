...
/**
 * taiji 共享 Tailwind preset（v3 冷蓝暗色，ADR-0019）。
 *
...
export default {
  ...
  plugins: [
    ...
    // 三件套，7 组件消费：Turn/Composer/AskUserOverlay/SystemNotice/BashOutputBlock/
    // ForkNotice/WidgetArea）。宽度数值 SSOT 仍是 style.css 的 --content-max-w
