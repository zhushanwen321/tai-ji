 ...
 *
 * 形态分类（契约见 .taiji-harness/2026-06-23-render-runtime-integration/contract.md §2.3）：
 ...
 */
import type { NormalizedQuotaRow, QuotaConfigurePayload, QuotaFetchFailureReason } from '@taiji/shared'
