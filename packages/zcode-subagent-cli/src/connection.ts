 ...
 * TAIJI_AGENT_SUBAGENT=1 + 剥离引擎原生嵌套标记），遥测关闭（旧实现实证）。
...
export interface AppServerConnectionOptions {
   ...
   * （TAIJI_AGENT_DATA_DIR）。app-server 的 ZCODE_* 专属键（隔离库路径 / launcher 键）
