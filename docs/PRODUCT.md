...
> 2026-08-02 视觉方向裁决：推翻早期冷蓝暗色定位（ADR-0019，已否），收敛到太极纯灰水墨系。色相决策记录见 [ADR-0066](docs/adr/decisions.md)，原子值见 [`packages/renderer/src/style.css`](../packages/renderer/src/style.css)（值真值；登记对照 [DESIGN.md](DESIGN.md) §4）。品牌名「太极」取自阴阳鱼 logo——双鱼咬尾、阴阳相生，隐喻 Agent 协作中人与 AI 的动态平衡。
...
- **不是冷蓝系**：冷蓝（`#4f8ef7`）已在 2026-08-02 推翻——长时间用眼下冷蓝相会产生色疲劳，纯灰更中性更耐久。V3 决策详见 [ADR-0066](docs/adr/decisions.md)
