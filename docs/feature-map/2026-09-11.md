...
> 本版反映「Taiji 30+ 天长跑稳定性专项」三大交付落地后的状态。上一版 [2026-09-06.md](2026-09-06.md)（后台命令侧边栏视图）保留作当时快照。专项全链：[long-run-stability-architecture.md](../design/long-run-stability-architecture.md)（G1-G4 / E1-E7 三阶段）→ prevention-deep-dive（O1-O4 批次 1-4；已删除，git 可追溯）→ 本版三大子项。
