...
| 设计 | `docs/design/crash-resilience.md`（v9）· `docs/design/idle-pi-reclamation.md`（已删除，git 可追溯）· `docs/design/crash-forensics-and-watchdog.md`（v9） |
| 实施计划 | `crash-resilience.impl-plan.md`（13 单元 + Gate A/B 记录）· `idle-pi-reclamation.impl-plan.md`（6 单元 + Gate A/B 记录，已删除，git 可追溯）· `crash-forensics-and-watchdog.impl-plan.md`（21 单元 + Gate A/B 记录 + Gate B verdict 表） |
