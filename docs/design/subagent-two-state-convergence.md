...
isOccupied(r)   = r.status === 'running' && r.stopReason === undefined
                  ...
                  // （record-store-rounds.ts:87-91），U6 批扩为增清 stopReason + revive 格
