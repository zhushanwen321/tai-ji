...
| 20 | pi-plan 无外部消费（§5.3 证据） | 全仓 `rg -l "@zhushanwen/pi-plan"`：extension-dependencies.json、goal CHANGELOG、`packages/core/src/domain/new-task-search/launch-config.test.ts`、一个 .taiji-harness 产物 plan.md——无生产消费方 | 属实 |
