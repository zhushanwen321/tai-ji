...
// （crash-resilience D6-⑦，该设计文档已删 git 可追溯）运行时 import '@taiji/shared'
...
function diff(id, model) {
  ...
  const actual = computeSupportedLevels(model) // registry 计算路径（taiji 唯一入口）
