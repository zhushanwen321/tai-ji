...
| zcode 引擎改造需求 | [docs/design/zcode-engine-improvement-requirements.md](docs/design/zcode-engine-improvement-requirements.md)（zcode vs pi 引擎 8 问调研结论 + 缺陷分级 A-D + 需求 R1-R10 清单；tech-design 输入，上游结论锚定 ZCode bundle 0.13.3，升级需重验） |
