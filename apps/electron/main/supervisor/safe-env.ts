 ...
 */
import { ENV_WHITELIST_PREFIXES, composeChildEnvBase } from '@taiji/shared'
 ...
 * 边界」，而 B2（main→runtime）是产品内部边界：process-control 注入的 TAIJI_AGENT_PACKAGED /
 * TAIJI_RUNTIME_TOKEN 正是 runtime 进程自身的合法输入（isPackaged() 六处判定 + WS 鉴权
